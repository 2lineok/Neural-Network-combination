...
for epoch in range(num_epochs):
    ...
    if epoch % 10000 == 0:
        ...
        torch.save(model, 'deep_onet_modelch12.pth')

        # Save the model's state dictionary (recommended)
        torch.save(model.state_dict(), 'deep_onet_model_state_dictch12.pth')

        # Save the optimizer's state (optional)
        torch.save(optimizer.state_dict(), 'deep_onet_optimizer_state_dictch12.pth')
